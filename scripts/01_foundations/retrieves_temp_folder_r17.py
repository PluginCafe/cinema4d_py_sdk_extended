...
def GetTempFolder(instalDir):
    ...
    if not os.path.exists(tempFolder) or tempFolder is None:
        raise RuntimeError("Failed to retrieve appdata folder.")
    ...
    if not parentName:
        raise RuntimeError("Failed to retrieve parent Name folder")
...
def main():
    ...
    winInstallationPath = r"C:\Program Files\MAXON\Cinema 4D R20"
    macInstallationPath = r"/Users/m_adam/Application/MAXON/Cinema 4D R20"
