...
Class/method highlighted:
    ...
    - maxon.frameworks.volume.VolumeToolsInterface.ConvertSDFToFog()
...
def main():
    ...
    finalVolume = maxon.frameworks.volume.VolumeToolsInterface.MixVolumes(vol1, vol2, c4d.MIXTYPE_MULTIPLY)
